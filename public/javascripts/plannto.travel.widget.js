...
var count = 0;
  for (var i = 0; i < scripts.length; i++) 
  {
    ...
    src = element.src;
      ...
      if (src.indexOf(domain+"/javascripts/plannto.travel.widget.js") != -1)
      {
...
PlannTo.onchange_function = function onchange_function(obj,moredetails)
  ...
  PlannTo.wheretobuytabclick = function wheretobuytabclick(obj,moredetails,item_ids)
  {
    ...
    PlannTo.related_hotel_tab_click = function related_hotel_tab_click(obj,moredetails,item_ids)
  {
        ...
        var element_id = PlannTo.jQuery(obj).parent().parent().parent().parent().next().children()
        parentDiv = PlannTo.jQuery(obj).parent().parent().parent().parent().parent().parent().parent().attr('id');
        url = "http://"+domain + "/travels/related_hotels.js" + "?item_ids="+item_ids+"&price_full_details="+show_details+ "&path=" + "offer" +"&ref_url="+pathname+"&doc_title-"+doc_title+"&callback=?";
