PlanNto::Application.configure do
  ...
  config.action_controller.asset_host = "http://d1yhmol44kh9to.cloudfront.net/static"
  ...
  PlanNto::Application.config.middleware.use ExceptionNotification::Rack,
                                             :email => {
