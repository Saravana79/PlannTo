...
namespace :admin do
  ...
  post "/admin/orders/update", :to => "admin/order_histories#update", :as => :admin_order_update
  ...
  get "/opt_out",:to => "home#opt_out"
  get "/opt_out_submit",:to => "home#opt_out_submit"
...
resources :accounts do
  ...
  post 'account_update', :to => "accounts#update", :as => "account_update", :as => "account_update_manual"
...
resources :comments do
  ...
  resources :messages
  get "/create_message/:id/:method" => 'messages#create_message', :as => :create_message
  get "/messages/block_user/:id" => 'messages#block_user', :as => :block_user
  get "/messages/:id/threaded" => 'messages#threaded_msg', :as => :threaded_msg
