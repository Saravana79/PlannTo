class Admin::AdReportsController < ApplicationController
  ...
  def index
    ...
    click_report = Click.find_by_sql("select count(*) as clicks_count, ad.id from clicks c join add_impressions1 i on c.impression_id=i.id join advertisements ad
    ...
    impression_report = AddImpression.find_by_sql("select count(*) as impressions_count, ad.id from add_impressions1 i join advertisements ad on i.advertisement_id=ad.id where
