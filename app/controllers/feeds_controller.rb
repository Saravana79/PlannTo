class FeedsController < ApplicationController
  ...
  def feed_urls
    ...
    unless params[:search].blank?
      ...
      condition = condition + " and created_at > '#{params[:search][:from_date].to_time.beginning_of_day}'" unless params[:search][:from_date].blank?
      condition = condition + " and created_at < '#{params[:search][:to_date].to_time.end_of_day}'" unless params[:search][:to_date].blank?
