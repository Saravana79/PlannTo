class UpdateItemDetailsFromVendorsFlipkart
  extend HerokuResqueAutoScale if Rails.env.production?
  extend Resque::Plugins::Retry
  @queue = :update_item_details_from_vendors_flipkart

  def self.perform(method_name, actual_time)
    log = Logger.new 'log/update_item_details_from_vendors_flipkart.log'
    #begin
    log.debug "********** Start Processing Itemdetail Update From Vendors Flipkart**********"
    ...
    #end
    log.debug "********** End Processing Itemdetail Update From Vendors Flipkart **********"
    log.debug "\n"
  end
end
