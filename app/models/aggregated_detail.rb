    ...
    if $redis.get("update_aggregated_detail_is_running").to_i == 0
      ...
      begin
        ...
        impressions.each do |each_imp|
          ...
          aggregated_detail = AggregatedDetail.find_or_initialize_by_entity_id_and_date_and_entity_type(each_imp.entity_id, time.to_date, entity_type)
      ...
      begin
        ...
        clicks.each do |each_click|
          aggregated_detail = AggregatedDetail.find_or_initialize_by_entity_id_and_date_and_entity_type(each_click.entity_id, time.to_date, entity_type)
  ...
  def self.update_aggregated_details_from_mongo_reports(time,entity_type="advertisement", type="Advertisement", force=false )
    ...
    results.each do |each_result|
      begin
        ...
        aggregated_detail = AggregatedDetail.find_or_initialize_by_entity_id_and_date_and_entity_type(entity_id, time.to_date, entity_type)
