...
ActiveRecord::Schema.define(:version => 20160428133233) do
  ...
  create_table "adv_details", :force => true do |t|
    ...
    t.string   "exp_video_width"
    t.string   "exp_video_height"
  end
  ...
  create_table "category_item_details", :force => true do |t|
    t.string   "item_type"
    t.string   "category"
  ...
  create_table "feed_urls", :id => false, :force => true do |t|
    t.integer  "id",                                                               :null => false
    t.integer  "feed_id"
    t.string   "url"
    t.string   "title"
  ...
  add_index "feed_urls", ["id", "created_at"], :name => "constr_id_created_at", :unique => true
  add_index "feed_urls", ["id", "created_at"], :name => "id", :unique => true
  ...
  create_table "item_beauty_details", :force => true do |t|
    t.text     "name"
    t.string   "url"
  ...
  add_index "sourceitems", ["additional_details"], :name => "index_sourceitems_on_additional_details"
