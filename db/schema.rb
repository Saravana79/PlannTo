...
ActiveRecord::Schema.define(:version => 20120418142423) do
  ...
  create_view "view_article_contents", "select `contents`.`id` AS `id`,`contents`.`title` AS `title`,`contents`.`description` AS `description`,`contents`.`type` AS `type`,`contents`.`created_by` AS `created_by`,`contents`.`updated_by` AS `updated_by`,`contents`.`itemtype_id` AS `itemtype_id`,`contents`.`created_at` AS `created_at`,`contents`.`updated_at` AS `updated_at`,`article_contents`.`url` AS `url`,`article_contents`.`thumbnail` AS `thumbnail`,`article_contents`.`article_category_id` AS `article_category_id`,`article_contents`.`field1` AS `field1`,`article_contents`.`field2` AS `field2`,`article_contents`.`field3` AS `field3`,`article_contents`.`field4` AS `field4` from (`contents` join `article_contents`) where (`contents`.`id` = `article_contents`.`id`)", :force => true do |v|
    v.column :id
    v.column :title
    v.column :description
    v.column :type
  ...
  create_view "view_event_contents", "select `contents`.`id` AS `id`,`contents`.`title` AS `title`,`contents`.`description` AS `description`,`contents`.`type` AS `type`,`contents`.`created_by` AS `created_by`,`contents`.`updated_by` AS `updated_by`,`contents`.`itemtype_id` AS `itemtype_id`,`contents`.`created_at` AS `created_at`,`contents`.`updated_at` AS `updated_at`,`event_contents`.`url` AS `url`,`event_contents`.`start_date` AS `start_date`,`event_contents`.`end_date` AS `end_date`,`event_contents`.`location` AS `location` from (`contents` join `event_contents`) where (`contents`.`id` = `event_contents`.`id`)", :force => true do |v|
    v.column :id
    v.column :title
    v.column :description
    v.column :type
  ...
  create_view "view_plannto_contents", "select `contents`.`id` AS `id`,`contents`.`title` AS `title`,`contents`.`description` AS `description`,`contents`.`type` AS `type`,`contents`.`created_by` AS `created_by`,`contents`.`updated_by` AS `updated_by`,`contents`.`itemtype_id` AS `itemtype_id`,`contents`.`created_at` AS `created_at`,`contents`.`updated_at` AS `updated_at`,`plannto_contents`.`field1` AS `field1` from (`contents` join `plannto_contents`) where (`contents`.`id` = `plannto_contents`.`id`)", :force => true do |v|
    v.column :id
    v.column :title
    v.column :description
    v.column :type
